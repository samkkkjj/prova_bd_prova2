...
USE avaliacao_22a;
#Exercicio1
INSERT INTO Livros (titulo, autor, ano_publicacao, disponivel, categoria, isbn, editora, quantidade_paginas, idioma) VALUES ('As Crônicas de Nárnia', 'C.S. Lewis', '1950', 'disponivel', 'Fantasia', 'ISBN 978-0064471190', 'Harper Collins', '768', 'Francês');

#Exercicio2
UPDATE Livros
SET disponivel = FALSE < 1980
